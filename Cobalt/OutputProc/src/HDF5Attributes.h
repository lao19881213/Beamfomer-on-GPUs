...
//#
//# $Id: HDF5Attributes.h 24388 2013-03-26 11:14:29Z amesfoort $
...
namespace LOFAR
{
  namespace Cobalt
  {
    ...
    template<>
    hid_t h5nativeType<float>()
    {
      return H5T_NATIVE_FLOAT;
    }
    template<>
    hid_t h5nativeType<double>()
    {
      return H5T_NATIVE_DOUBLE;
    }
    template<>
    hid_t h5nativeType<unsigned>()
    {
      return H5T_NATIVE_UINT;
    }
    template<>
    hid_t h5nativeType<int>()
    {
      return H5T_NATIVE_INT;
    }
    template<>
    hid_t h5nativeType<bool>()
    {
    ...
    template<>
    hid_t h5writeType<float>()
    {
      return H5T_IEEE_F32LE;
    }
    template<>
    hid_t h5writeType<double>()
    {
      return H5T_IEEE_F64LE;
    }
    template<>
    hid_t h5writeType<unsigned>()
    {
      return H5T_STD_U32LE;
    }
    template<>
    hid_t h5writeType<int>()
    {
      return H5T_STD_I32LE;
    }
    template<>
    hid_t h5writeType<bool>()
    {
      return H5T_STD_I32LE;
    }                                                               // emulate bool with a 32-bit int

    // C->HDF5 translations of types to use for data (CNProc endianness)
    template<typename T>
    hid_t h5dataType( bool bigEndian );

    template<>
    hid_t h5dataType<float>( bool bigEndian )
    {
      return bigEndian ? H5T_IEEE_F32BE : H5T_IEEE_F32LE;
    }

    template<>
    hid_t h5dataType<LOFAR::fcomplex>( bool bigEndian )
    {
    ...
    template<typename T>
    void writeAttribute( hid_t loc, const char *name, T value )
    {
    ...
    template<typename U>
    void writeAttributeV( hid_t loc, const char *name, std::vector<U> value )
    {
    ...
    template<>
    void writeAttribute( hid_t loc, const char *name, char const *value )
    {
      h5auto dataspace(h5scalar(), H5Sclose);
    ...
    template<>
    void writeAttribute( hid_t loc, const char *name, const std::string value )
    {
      writeAttribute(loc, name, value.c_str());
    }

    template<>
    void writeAttributeV( hid_t loc, const char *name, std::vector<const char *> value )
    {
      h5auto dataspace(h5array(value.size()), H5Sclose);
      h5auto datatype(h5stringType(), H5Tclose);
    ...
    template<>
    void writeAttributeV( hid_t loc, const char *name, std::vector<std::string> value )
    {
